...
local MyViewController = class "MyViewController" {extends = {CCKit.CCViewController, CCKit.CCEventHandler}} {
    toggleName = nil,
    sliderName = nil,
    __init = function()
        _ENV.CCEventHandler("MyViewController")
        self.button = CCKit.CCButton(4, 9, 8, 1)
        self.counter = CCKit.CCLabel(13, 5, " 0")
    end,
